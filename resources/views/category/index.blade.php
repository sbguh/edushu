...
<div class="page">
  ...
  <div class="page__hd">
      <p class="page__desc page_header_title">分类</p>
      <div class="categories">
        @foreach($categories as $category)
        <div class="tags">
            <div class="clearfix">
              <div class="float-left title">{{$category->name}}:</div>
            @foreach($category->hasManyChildren()->get() as $childrencategory)
            <p><a href="{{route('category.show',$childrencategory->id)}}">{{$childrencategory->name}}</a></p>
            @endforeach
          </div>
        </div>
        @endforeach
  ...
  <div class="page__hd">
      <p class="page__desc page_header_title">热门书籍</p>
  </div>
  <div class="row">
